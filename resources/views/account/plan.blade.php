                ...
                <div class="col-12 col-md-6 p-2 d-flex align-items-center">
                    ...
                    <div class="{{ ($user->plan->features->links == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-3') }}">
                        ...
                        @elseif($user->plan->features->links)
                            <span class="text-muted">{{ number_format($linksCount, 0, __('.'), __(',')) }} /</span> {{ __(($user->plan->features->links == 1 ? ':number link' : ':number links'), ['number' => number_format($user->plan->features->links, 0, __('.'), __(','))]) }}
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 p-2 d-flex align-items-center">
                    ...
                    <div class="{{ ($user->plan->features->spaces == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-3') }}">
                        ...
                        @elseif($user->plan->features->spaces)
                            <span class="text-muted">{{ number_format($user->spacesCount, 0, __('.'), __(',')) }} /</span> {{ __(($user->plan->features->spaces == 1 ? ':number space' : ':number spaces'), ['number' => number_format($user->plan->features->spaces, 0, __('.'), __(','))]) }}
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 p-2 d-flex align-items-center">
                    ...
                    <div class="{{ ($user->plan->features->domains == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-3') }}">
                        ...
                        @elseif($user->plan->features->domains)
                            <span class="text-muted">{{ number_format($user->domainsCount, 0, __('.'), __(',')) }} /</span> {{ __(($user->plan->features->domains == 1 ? ':number domain' : ':number domains'), ['number' => number_format($user->plan->features->domains, 0, __('.'), __(','))]) }}
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 p-2 d-flex align-items-center">
                    ...
                    <div class="{{ ($user->plan->features->pixels == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-3') }}">
                        ...
                        @elseif($user->plan->features->pixels)
                            <span class="text-muted">{{ number_format($user->pixelsCount, 0, __('.'), __(',')) }} /</span> {{ __(($user->plan->features->pixels == 1 ? ':number pixel' : ':number pixels'), ['number' => number_format($user->plan->features->pixels, 0, __('.'), __(','))]) }}
                        @endif
                    </div>
                </div>
