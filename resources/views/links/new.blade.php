    ...
    <div class="card-body">
        <form action="{{ route('links.new') }}" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-12 collapse{{ ($errors->has('alias') || $errors->has('domain_id') || $errors->has('space_id') || $errors->has('expiration_url') || $errors->has('expiration_clicks') || $errors->has('password') || $errors->has('expiration_date') || $errors->has('expiration_time') || $errors->has('privacy') || $errors->has('privacy_password') || $errors->has('disabled') || $errors->has('country.*.key') || $errors->has('country.*.value') || $errors->has('platform.*.key') || $errors->has('platform.*.value') || $errors->has('language.*.key') || $errors->has('language.*.value') || $errors->has('rotation.*.value')) ? ' show' : '' }}" id="advanced-options">
                    <div class="row mt-3 mx-n2">
                        <div class="col-12 col-lg-6 px-2">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        <label for="i-domain-id-new">{{ __('Domain') }}</label>
                                    </div>
                                </div>
                                <div class="input-group">
                                    ...
                                    <select name="domain_id" id="i-domain-id-new" class="custom-select{{ $errors->has('domain_id') ? ' is-invalid' : '' }}">
                        ...
                        <div class="col-12 col-lg-6 px-2">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        <label for="i-space-id-new">{{ __('Space') }}</label>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="space_id" id="i-space-id-new" class="custom-select{{ $errors->has('space_id') ? ' is-invalid' : '' }}" @cannot('spaces', ['App\Models\Link']) disabled @endcannot>
                        ...
                        <div class="col-12 px-2">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        <label for="i-pixel-ids">{{ __('Pixels') }}</label>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <select name="pixel_ids[]" id="i-pixel-ids" class="custom-select{{ $errors->has('space_id') ? ' is-invalid' : '' }}" size="{{ (count($pixels) == 0 ? 1 : 3) }}" @cannot('pixels', ['App\Models\Link']) disabled @endcannot multiple>
                                    @foreach($pixels as $pixel)
                                        <option value="{{ $pixel->id }}" @if(old('pixel_ids') !== null && in_array($pixel->id, old('pixel_ids'))) selected @endif>{{ $pixel->name }} ({{ config('pixels')[$pixel->type]['name'] }})</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="country-container" class="tab-pane fade{{ old('target_type') == 1 ? ' show active' : '' }}">
                                    <div class="input-content mt-3">
                                        <div class="form-row d-none input-template">
                                            <div class="col-12 col-md">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
