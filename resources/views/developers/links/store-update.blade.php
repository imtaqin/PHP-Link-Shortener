@php
    ...
    $parameters[] = [
        ...
        'type' => 0,
        'format' => 'string',
        'description' => __('The code of the targeted country.') . ' ' . __('The code must be in :standard standard.', ['standard' => '<a href="https://wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements" target="_blank" rel="nofollow noreferrer noopener">ISO 3166-1 alpha-2</a>'])
    ];
    ...
    $parameters[] = [
        ...
        'type' => 0,
        'format' => 'string',
        'description' => __('The code of the targeted language.') . ' ' . __('The code must be in :standard standard.', ['standard' => '<a href="https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes" target="_blank" rel="nofollow noreferrer noopener">ISO 639-1 alpha-2</a>'])
    ];
