                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            ...
                            <div class="dropdown-menu {{ (__('lang_dir') == 'rtl' ? 'dropdown-menu' : 'dropdown-menu-right') }} border-0 shadow width-64 p-0" id="search-filters">
                                ...
                                <input name="space_id" type="hidden" value="{{ request()->input('space_id') }}">
                                <input name="domain_id" type="hidden" value="{{ request()->input('domain_id') }}">
                                <input name="pixel_id" type="hidden" value="{{ request()->input('pixel_id') }}">
