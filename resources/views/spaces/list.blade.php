                            ...
                            <div class="col text-truncate">
                                <div class="row align-items-center">
                                    ...
                                    <div class="d-none d-lg-block col-lg-2 text-truncate">
                                        <span class="text-truncate" data-tooltip="true" title="{{ $space->created_at->tz(Auth::user()->timezone ?? config('app.timezone'))->format(__('Y-m-d') . ' H:i:s') }}">{{ $space->created_at->diffForHumans() }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
