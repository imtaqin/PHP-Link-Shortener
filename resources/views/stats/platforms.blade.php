                                        ...
                                        <div class="d-flex align-items-center text-truncate">
                                            @if(isset($first->value))
                                                <div class="d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">
                                                    <img src="{{ asset('img/icons/platforms/'.formatPlatform($first->value ?? '')) }}.svg" class="width-4 height-4">
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="d-flex align-items-center text-truncate">
                                            @if(isset($last->value))
                                                <div class="d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">
                                                    <img src="{{ asset('img/icons/platforms/'.formatPlatform($last->value ?? '')) }}.svg" class="width-4 height-4">
                                                </div>
                            ...
                            <div class="list-group-item px-0 border-0">
                                <div class="d-flex flex-column">
                                    <div class="d-flex justify-content-between mb-2">
                                        <div class="d-flex text-truncate align-items-center">
                                            <div class="d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}"><img src="{{ asset('img/icons/platforms/'.formatPlatform($platform->value)) }}.svg" class="width-4 height-4"></div>
                                            <div class="text-truncate">
                                                @if($platform->value)
                                                    {{ $platform->value }}
                                                @else
